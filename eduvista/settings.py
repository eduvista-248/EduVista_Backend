"""
Django settings for eduvista project.
...
SECRET_KEY = 'django-insecure-()mro&tvubrdg-4-ast930yjh!e&h-%v_fts1qi6rkj9t=re6p'
...
WSGI_APPLICATION = 'eduvista.wsgi.application'
